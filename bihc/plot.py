...
class Plot:
    ...
    def plotPowerSpectrumFromTimber(startDate, beamNumber, save=True):
        ...
        f = db.get(
            freq, t1, t2
        )  # Siccome i filledbuckets non cambiano prendo tutti i valori dall'inizio
        ...
        plt.legend()
        if save:
            plt.savefig("PowerSpectrumFromTimber.png", transparent=True)
        plt.show()
